                ...
                <form class="layui-form kg-form" method="POST" action="{{ url({'for':'admin.setting.storage'}) }}">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="radio" name="driver" value="cos" title="腾讯云COS" {% if storage.driver != "local" %}checked="checked"{% endif %}>
                            <input type="radio" name="driver" value="local" title="本地存储" {% if storage.driver == "local" %}checked="checked"{% endif %}>
                        </div>
                    </div>
                    <div class="layui-form-item kg-storage-tip layui-hide" id="storage-local-tip">
                        <label class="layui-form-label"></label>
                        <div class="layui-input-block">
                            <p class="kg-cgray">本地存储目录：html/ctc/storage/upload</p>
                            <p class="kg-cgray">上传文件将按照上传时间的 年/月/日 目录自动存储</p>
                        </div>
                    </div>
                    <div id="cos-block">
                        <fieldset class="layui-elem-field layui-field-title">
        ...
        layui.use(['jquery'], function () {
            ...
            function toggleStorageType() {
                ...
                if (driver === 'local') {
                    ...
                    $('#cos-block').addClass('layui-hide');

                    $('#storage-local-tip').removeClass('layui-hide');

                } else {

                    $('#cos-block').removeClass('layui-hide');

                    $('#storage-local-tip').addClass('layui-hide');
                }
            }

            $('input[name=driver]').on('change', toggleStorageType);
